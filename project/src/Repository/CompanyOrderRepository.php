...
/**
 * @extends ServiceEntityRepository<CompanyOrder>
 *
...
class CompanyOrderRepository extends ServiceEntityRepository
{
    ...
    public function save(CompanyOrder $entity, bool $flush = false): void
    {
    ...
    public function remove(CompanyOrder $entity, bool $flush = false): void
    {
